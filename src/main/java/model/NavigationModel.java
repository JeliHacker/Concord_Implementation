...
public class NavigationModel
{
	...
	public NavigationModel(BorderPane view, Stage newStage)
	{
		loginview = view;
		d_m = new DataModel();
		d_m.add_program("P1");
	...
	public void open_program()
	{
		...
		loader.setLocation(NavigationModel.class.getResource("../views/program_page.fxml"));
		try
		{
			int width = 1216;
			int height = 684;
	...
	{
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(NavigationModel.class.getResource("../views/user_page.fxml"));
		try
		{
			Pane view = loader.load();
			loginview.setCenter(view);
	...
	{
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(NavigationModel.class.getResource("../views/registration_page.fxml"));
		try
		{
			Pane view = loader.load();
			loginview.setCenter(view);
	...
	{
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(NavigationModel.class.getResource("../views/login_page.fxml"));
		try
		{
			Pane view = loader.load();
			loginview.setCenter(view);
	...
	{
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(NavigationModel.class.getResource("../views/add_program_page.fxml"));
		try
		{
			Pane view = loader.load();
			loginview.setCenter(view);
	...
	{
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(NavigationModel.class.getResource("../views/add_channel_page.fxml"));
		try
		{
			Pane view = loader.load();
			loginview.setCenter(view);
	...
	{
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(NavigationModel.class.getResource("../views/add_user_page.fxml"));
		try
		{
			Pane view = loader.load();
			loginview.setCenter(view);
